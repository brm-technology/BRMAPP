...
const PipeB3610Data = ({ title, description }) => {
  ...
  useEffect(() => {
    const apiUrl = "/api/pipe/asmeb3610/";
          ...
          {filteredProjects.map((project) => (
            <div
              ...
              <table className="specs-table">
                <tbody>
                  <tr>
                    <td><strong>OD:</strong> {project.OD} mm</td>
                    <td><strong>ID:</strong> {(project.OD - project.Thk * 2).toFixed(2)} mm</td>
                  </tr>
                  <tr>
                    <td><strong>Thk:</strong> {project.Thk} mm</td>
                    <td><strong>Weight:</strong> {project.Weight} kg/m</td>
                  </tr>
                </tbody>
              </table>
